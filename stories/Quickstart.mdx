...
Use the `TimelineContext` to wrap your timeline, and access the timeline helpers using the `useTimelineContext` hook.

This is the recommended way to use the `dnd-timeline`
